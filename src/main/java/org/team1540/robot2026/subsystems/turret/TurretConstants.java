...
public class TurretConstants {
    ...
    public static final Rotation2d MAX_ANGLE = Rotation2d.fromDegrees(510 - ANGLE_OFFSET.getDegrees());
    public static final Rotation2d MIN_ANGLE = Rotation2d.fromDegrees(25 - ANGLE_OFFSET.getDegrees());
    ...
    public static final double CRUISE_VELOCITY_RPS = 0.75; // was 3
