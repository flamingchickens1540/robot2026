...
public class LimelightHelpers {
    ...
    public static class RawDetection {
        public int classId = 0; // What object was detected
        public double txnc = 0; // Horizontal angle to object
        public double tync = 0; // Vertical angle to object
        public double ta = 0; // How large the object appears
        public double corner0_X = 0; // Pixel coordinates of bounding box corners
