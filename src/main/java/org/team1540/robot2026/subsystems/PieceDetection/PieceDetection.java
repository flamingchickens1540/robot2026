...
public class PieceDetection extends SubsystemBase {
    ...
    private final LoggedTunableNumber farthestBallDistancePointsM =
            new LoggedTunableNumber("the point value each meter of additional distance takes");
            ...
            case 0:
                {
                    ...
                    Triangle triangle = new Triangle(
                            new Vector2(0, coneLength.getAsDouble() / 2),
                            new Vector2(0, -coneLength.getAsDouble() / 2),
                            new Vector2());
            ...
            case 3:
                {
                    ...
                    if (detections.length > 1) {
                        ...
                        assert centroidWithSmallestDistance
                                != null; // yeah the closest cluster being millions away doesn't make sense
                        targetAngle =
                                Math.atan2(centroidWithSmallestDistance.getY(), centroidWithSmallestDistance.getX());
