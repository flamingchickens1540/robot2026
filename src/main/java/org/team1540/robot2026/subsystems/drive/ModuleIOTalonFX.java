...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(ODOMETRY_FREQUENCY, drivePosition, turnPosition);
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        StatusCode turnStatus = BaseStatusSignal.refreshAll(
                turnPosition, turnVelocity, turnAppliedVolts, turnStatorCurrent, turnSupplyCurrent, turnTemp);
    ...
    public void setDriveVelocityTorqueCurrent(double velocityRadPerSec, double ffCurrentAmps) {
        drive.setControl(driveVelocityTorqueReq
                .withVelocity(Units.radiansToRotations(velocityRadPerSec))
                .withFeedForward(ffCurrentAmps));
    }
